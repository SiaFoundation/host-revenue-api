...
func (s *Store) AddMarketData(usd, eur, btc float64, timestamp time.Time) error {
...
func (s *Store) GetExchangeRate() (usd, eur, btc float64, timestamp time.Time, err error) {
